    ...
    context "running through rux" do
      ...
      it "verifies exit codes for different failure scenarios" do
        chdir(fixture_dir) do
          ...
          result4 = run_rux_allowing_errors("spec/calculator_spec.rb")
  ...
  describe "Edge cases" do
    ...
    context "when command doesn't exist" do
      it "shows error when command doesn't exist" do
        result = run_rux_allowing_errors("--command=nonexistentcommand", "spec/rux_error_handling_spec.rb", "--debug")

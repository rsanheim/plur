...
RSpec.describe Backspin do
  ...
  context "record" do
    it "records stdout, stderr, and status to a single yaml" do
      ...
      expect(result.cassette_path).to eq(backspin_path.join("echo_hello.yaml"))
    ...
    it "records to an autogenerated path if no record_as is provided" do
      ...
      expect(result.cassette_path.to_s).to match(%r{tmp/backspin/Backspin/record/records_to_an_autogenerated_path_if_no_record_as_is_provided\.yaml$})

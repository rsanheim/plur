...
* [ ] other tasks TODO...
* [ ] BEFORE marking complete -- the entire test suite MUST pass

## Phase 3 - Remove all mapping related docs, config examples, etc

* [ ] if there are comparative analysis docs, we may want to keep some -- we can review those when we get to this point
* [ ] other tasks TODO...

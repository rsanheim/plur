...
- **Cache overhead threshold:** RuboCop post-cleanup cache load/save still exceeds the measurement plan's combined threshold, though the gap is smaller than before the compact JSON and schema-shape cleanup.

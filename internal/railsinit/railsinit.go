...
func printInitSummary(cfg *config.GlobalConfig, result *initResult) {
	...
	if result.changesApplied > 0 && !cfg.DryRun {
		...
		fmt.Println("  2. RAILS_ENV=test plur rails db:create    - Create parallel test databases")
		fmt.Println("  3. RAILS_ENV=test plur rails db:migrate   - Run migrations on all test databases")
		...
		fmt.Println()
		fmt.Println("Next steps:")
		fmt.Println("  1. RAILS_ENV=test plur rails db:create    - Create parallel test databases")
		fmt.Println("  2. RAILS_ENV=test plur rails db:migrate   - Run migrations on all test databases")

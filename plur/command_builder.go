...
type CommandBuilder interface {
	BuildCommand(files []string, globalConfig *config.GlobalConfig, command string) []string
}

// NewCommandBuilder creates the appropriate command builder based on the framework
func NewCommandBuilder(framework config.TestFramework) CommandBuilder {
	switch framework {
...
func (r *RSpecCommandBuilder) BuildCommand(files []string, globalConfig *config.GlobalConfig, command string) []string {
...
func (m *MinitestCommandBuilder) BuildCommand(files []string, globalConfig *config.GlobalConfig, command string) []string {
